...
if pagina == 'Analyse geluid':
    ...
    numeric_colsy = ['distance', 'altitude', 'windspeed', 'winddirection', 'duration', 'TG_C']


    st.title("✈️ Filtered Scatterplot of Aircraft Noise & Flight Data")
    grouping_col = st.selectbox("🎨 Kleur op basis van:", ['type', 'tags_cleaned','operator'])
